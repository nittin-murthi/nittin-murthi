...
[![My Skills](https://skillicons.dev/icons?i=anaconda,aws,c,py,pytorch,sqlite,sklearn,tensorflow,visualstudio,cpp,docker,github,latex,mysql,nodejs,npm,pycharm,html,js,css,wasm)](https://skillicons.dev)
