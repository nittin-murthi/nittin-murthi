...
[![My Skills](https://skillicons.dev/icons?i=anaconda,aws,c, py,pytorch, sqlite, sklearn, tensorflow, visualsudio,  cpp, docker, github, latex, mysql, nodejs, npm, pycharm, ,html,css,wasm)](https://skillicons.dev)
